...
namespace Woi.HazardSystem	
{
	public abstract class Hazard : MonoBehaviour, IHazard, IInteractable
	{
		...
		{
			EventBus.Register<OnLanguageChanged>(SetHazardData);
		}

		protected virtual void OnDisable()
		{
			EventBus.Deregister<OnLanguageChanged>(SetHazardData);
		}
		...
		public void Fix()
		{
			...
			EventBus.Raise(new OnHazardFixed(currentData.TaskName, currentData.description, currentData.score, currentData.soundDefinition, currentData.hazardID));
