...
namespace Woi.OfficeFire
{
    ...
    /// <summary>
    /// Grows archive fire visuals in timed stages after the player enters the room.
    /// Each stage enables its objects and animates local scale from 0 to the cached original scale.
    /// </summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("Woi/Office Fire/Archive Room Fire Growth")]
    public sealed class ArchiveRoomFireGrowthController : MonoBehaviour
    {
        [SerializeField]
        ...
        private void Log(string message)
        {
            ...
            Debug.Log($"[ArchiveRoomFireGrowth] {message}", this);
        }
        ...
        private void LogWarning(string message)
        {
            ...
            Debug.LogWarning($"[ArchiveRoomFireGrowth] {message}", this);
        }
    }
}
