...
{
    /// <summary>
    /// Keeps <c>EstinguisherHUD</c> hidden until the player equips an extinguisher in the Kitchen Cafe scenario.
    /// </summary>
    [DisallowMultipleComponent]
    [DefaultExecutionOrder(-100)]
    [AddComponentMenu("Woi/Office Fire/Kitchen Extinguisher HUD Bridge")]
    public sealed class OfficeFireKitchenExtinguisherHudBridge : MonoBehaviour
    {
