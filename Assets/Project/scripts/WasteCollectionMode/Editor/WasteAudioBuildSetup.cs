    ...
    public static class WasteAudioBuildSetup
    {
        ...
        private static readonly CategoryEntry[] Entries =
        {
            ...
            new CategoryEntry(4, "Metal", "10",
                "Metal (alüminyum) içecek kutuları ve metal (çelik) gıda kutuları 'Metal Atıklar' atık kutusuna atılmalıdır.",
                "Aluminium beverage cans and steel food cans should be placed in the 'Metal Waste' bin."),
