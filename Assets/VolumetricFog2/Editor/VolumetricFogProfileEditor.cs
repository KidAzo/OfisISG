...
namespace VolumetricFogAndMist2 {
    ...
    public class VolumetricFogProfileEditor : Editor {
        ...
        public override void OnInspectorGUI () {
            ...
            showColors = DrawHeader("Colors", PrefsColors, showColors);
            if (showColors) {
            ...
            showTerrain = DrawHeader("Terrain Fit", PrefsTerrain, showTerrain);
            if (showTerrain) {
            ...
            showAnimation = DrawHeader("Animation", PrefsAnimation, showAnimation);
            if (showAnimation) {
            ...
            showLighting = DrawHeader("Lighting & Shadows", PrefsLighting, showLighting);
            if (showLighting) {
            ...
            showDistantFog = DrawHeader("Distant Fog", PrefsDistantFog, showDistantFog);
            if (showDistantFog) {
